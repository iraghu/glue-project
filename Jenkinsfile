            ...
            steps {
                script {
                    ...
                    def updateJobCommand = """
                        aws glue create-job --name RawToRefinedScript-cicdJob \
                        --role arn:aws:iam::442116323705:role/glues3 \
                        --command "{\"Name\":\"glueetl\",\"ScriptLocation\":\"s3://gluerawbucket/glue-scripts-cicd/glue_scripts/LandingToRawScript.py\",\"PythonVersion\":\"3\"}"
